  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved permission as @permission" do
        ...
        post :create, {:permission => { "resource" => "invalid value" }}, valid_session
        assigns(:permission).should be_a_new(Permission)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested permission" do
        ...
        Permission.any_instance.should_receive(:update).with({ "resource" => "MyString" })
        put :update, {:id => permission.to_param, :permission => { "resource" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the permission as @permission" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Permission.any_instance.stub(:save).and_return(false)
        put :update, {:id => permission.to_param, :permission => { "resource" => "invalid value" }}, valid_session
        assigns(:permission).should eq(permission)
      end
