  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved fund as @fund" do
        ...
        post :create, {:fund => {  }}, valid_session
        assigns(:fund).should be_a_new(Fund)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested fund" do
        ...
        Fund.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => fund.to_param, :fund => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the fund as @fund" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Fund.any_instance.stub(:save).and_return(false)
        put :update, {:id => fund.to_param, :fund => {  }}, valid_session
        assigns(:fund).should eq(fund)
      end
