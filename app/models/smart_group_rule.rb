  ...
  def sql_conditions
    ...
    when "age"
        if self.operator.short === "between"
          ...
          start_date = (Time.now - self.content.to_i.years).strftime('%Y-%m-%d')
          cond = Caboose::EZ::Condition.new do
    ...
    when "have_group"
        ...
        cond = Caboose::EZ::Condition.new :groups do
            any do
                name === groups_to_find
            end
        end
    ...
    when "zip"
        ...
        cond = Caboose::EZ::Condition.new :households do
            any do
                zip === zips_to_find
            end
        end
    ...
    when "recent_group_attend"
      if self.operator.short === "before"
        ...
        cond = Caboose::EZ::Condition.new :attendance_trackers do
