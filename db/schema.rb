...
ActiveRecord::Schema.define(version: 20130307160255) do
  ...
  add_index "associates", ["id"], name: "index_associates_on_id"
  add_index "associates", ["organization_id"], name: "index_associates_on_organization_id"
  ...
  add_index "attendances", ["checkin_type_id"], name: "index_attendances_on_checkin_type_id"
  ...
  add_index "auto_groups", ["group_id"], name: "index_auto_groups_on_group_id"
  add_index "auto_groups", ["instance_type_id"], name: "index_auto_groups_on_instance_type_id"
  ...
  add_index "auto_instance_types", ["event_type_id"], name: "index_auto_instance_types_on_event_type_id"
  add_index "auto_instance_types", ["instance_type_id"], name: "index_auto_instance_types_on_instance_type_id"
  ...
  add_index "contact_types", ["default_responsible_ministry_id"], name: "index_contact_types_on_default_responsible_ministry_id"
  add_index "contact_types", ["default_responsible_user_id"], name: "index_contact_types_on_default_responsible_user_id"
  ...
  add_index "contacts", ["responsible_ministry_id"], name: "index_contacts_on_responsible_ministry_id"
  ...
  add_index "contributions", ["contributable_id"], name: "index_contributions_on_contributable_id"
  ...
  add_index "departments", ["responsible_person_id"], name: "index_departments_on_responsible_person_id"
  ...
  add_index "emails", ["comm_type_id"], name: "index_emails_on_comm_type_id"
  add_index "emails", ["email"], name: "index_emails_on_email"
  add_index "emails", ["emailable_id", "emailable_type"], name: "emailable_index"
  add_index "emails", ["household_id"], name: "index_emails_on_household_id"
  ...
  add_index "enrollments", ["enrolled_as_id"], name: "index_enrollments_on_enrolled_as_id"
  ...
  add_index "follow_ups", ["follow_up_type_id"], name: "index_follow_ups_on_follow_up_type_id"
  ...
  add_index "groups", ["attendance_requirement_id"], name: "index_groups_on_attendance_requirement_id"
  add_index "groups", ["curriculum_choice_id"], name: "index_groups_on_curriculum_choice_id"
  add_index "groups", ["curriculum_cost_id"], name: "index_groups_on_curriculum_cost_id"
  add_index "groups", ["default_room_id"], name: "index_groups_on_default_room_id"
  add_index "groups", ["deleted_at"], name: "index_groups_on_deleted_at"
  add_index "groups", ["is_childcare_provided_id"], name: "index_groups_on_is_childcare_provided_id"
  add_index "groups", ["leader_name_for_printing_id"], name: "index_groups_on_leader_name_for_printing_id"
  add_index "groups", ["lft"], name: "index_groups_on_lft"
  add_index "groups", ["meeting_cadence_id"], name: "index_groups_on_meeting_cadence_id"
  add_index "groups", ["meeting_place_id"], name: "index_groups_on_meeting_place_id"
  add_index "groups", ["meets_at_household_id"], name: "index_groups_on_meets_at_household_id"
  ...
  add_index "groups", ["special_requirement_id"], name: "index_groups_on_special_requirement_id"
  ...
  add_index "instance_types", ["start_time"], name: "index_instance_types_on_start_time"
  ...
  add_index "job_requirements", ["job_id"], name: "index_job_requirements_on_job_id"
  add_index "job_requirements", ["requirement_id"], name: "index_job_requirements_on_requirement_id"
  ...
  add_index "jobs", ["contact_person_id"], name: "index_jobs_on_contact_person_id"
  ...
  add_index "milestones", ["person_id"], name: "index_milestones_on_person_id"
  add_index "milestones", ["requirement_id"], name: "index_milestones_on_requirement_id"
  ...
  add_index "organizations", ["contr_count"], name: "index_organizations_on_contr_count"
  add_index "organizations", ["id"], name: "index_organizations_on_id"
  add_index "organizations", ["recent_contr"], name: "index_organizations_on_recent_contr"
  ...
  add_index "people", ["connected"], name: "index_people_on_connected"
  ...
  add_index "people", ["enrolled"], name: "index_people_on_enrolled"
  add_index "people", ["first_name", "last_name"], name: "full_name_index"
  add_index "people", ["first_name"], name: "index_people_on_first_name"
  add_index "people", ["has_a_picture"], name: "index_people_on_has_a_picture"
  ...
  add_index "phones", ["comm_type_id"], name: "index_phones_on_comm_type_id"
  add_index "phones", ["household_id"], name: "index_phones_on_household_id"
  ...
  add_index "phones", ["sms_setup_id"], name: "index_phones_on_sms_setup_id"
  ...
  add_index "relationship_roles", ["relationship_type_id"], name: "index_relationship_roles_on_relationship_type_id"
  ...
  add_index "relationships", ["person_role_id"], name: "index_relationships_on_person_role_id"
  add_index "relationships", ["relates_to_id"], name: "index_relationships_on_relates_to_id"
  add_index "relationships", ["relates_to_role_id"], name: "index_relationships_on_relates_to_role_id"
  ...
  add_index "smart_group_rules", ["operator_id"], name: "index_smart_group_rules_on_operator_id"
  add_index "smart_group_rules", ["property_id"], name: "index_smart_group_rules_on_property_id"
