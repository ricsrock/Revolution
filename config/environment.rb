...
Rails::Initializer.run do |config|
  ...
  config.load_paths += %W( #{RAILS_ROOT}/overrides )
  ...
  config.active_record.observers = :meeting_observer, :user_observer, :note_observer
...
GeoKit::Geocoders::google = 'ABQIAAAAH80fn2H2yyehQtUGABGjDhTQJQlR5ciN7KF_g6lggjoIHa2IKxQIJjVISWHTmDjyoH_l-7ph2RjnfA'
